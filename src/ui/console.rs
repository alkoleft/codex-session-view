...
use crate::events::types::{
    ...
    MESSAGE_USER, PATCH_APPLY, PATCH_APPLY_DUPLICATE, RAW_UNPARSED, RUNTIME_CONTEXT, SHELL_CALL,
    SHELL_RESULT, STDERR_LINE, STDIN_WRITE, TASK_COMPLETED, TASK_STARTED, TODO_UPDATE, TOOL_CALL,
...
impl<W: Write> WorkerConsole<W> {
    ...
    fn event_timeline_kind(&self, event: &EventRecord) -> &'static str {
        match event.event_type.as_str() {
            ...
            | WEB_SEARCH | WEB_OPEN | TODO_UPDATE => {
